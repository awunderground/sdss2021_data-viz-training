...
* `separate()` - split a character variable into multiple columns based on a delimeter
...
left_join(table4a_fixed, table4b_fixed, by = c("country", "year"))
...
tribble(
  ...
  separate(col = `male passengers/female passengers`,
           into = c("male passengers", "female passengers")) %>%
  pivot_longer(cols = c(`male passengers`, `female passengers`))
