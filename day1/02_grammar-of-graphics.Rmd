...
There are <font color="#55b748">eight</font> main ingredients to the grammar of graphics. We will work our way through the ingredients with many hands-on examples. 

### `r kableExtra::text_spec("Exercise 0", color = "#1696d2")`

<font color="#55b748">Step 1:</font> Open your `.Rproj`.
...
<font color="#55b748">Step 2:</font> Add `facet_wrap(~ category)`
